[getList]
SELECT a.* FROM 
(SELECT objid,username,lastname,firstname,middlename,jobtitle,txncode, state FROM sys_user u WHERE u.lastname LIKE $P{searchtext} 
UNION 
SELECT objid,username,lastname,firstname,middlename,jobtitle,txncode, state FROM sys_user u WHERE u.firstname LIKE $P{searchtext} 
UNION 
SELECT objid,username,lastname,firstname,middlename,jobtitle,txncode, state FROM sys_user u WHERE u.username LIKE $P{searchtext} 
) AS a 
