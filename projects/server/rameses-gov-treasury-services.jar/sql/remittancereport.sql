...
select 
    xx.formtypeindexno, xx.formno, xx.formtype, xx.stubno, 
...
group by xx.formtypeindexno, xx.formno, xx.formtype, xx.stubno
...
group by xx.formtypeindexno, xx.formno, xx.formtype, xx.stubno
order by xx.formtypeindexno, xx.formno, xx.series
