...
//						remarksdb.endTransaction();
					...
					for (int i=0; i<size; i++) {
						...
						for (int j=0; j<10; j++) {
							try {
								...
								response = svc.updateRemarksEncrypt(param);
								closeRemarks(response, proxy.getString("objid"));
								break;
			...
			private void closeRemarks(Map response, String objid) throws Exception {
				String str = "";
