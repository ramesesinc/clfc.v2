...
public class FaasPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xTitledBorder1.setTitle("Memoranda");
        ...
        xCheckBox3.setName("entity.rpu.taxable"); // NOI18N
        xCheckBox3.setOpaque(false);
        xCheckBox3.setText("Taxable? ");
        xFormPanel9.add(xCheckBox3);

        xComboBox9.setCaption("Exempt Reason");
        xComboBox9.setDepends(new String[] {"entity.rpu.taxable"});
        xComboBox9.setDynamic(true);
        xComboBox9.setEnabled(false);
        xComboBox9.setExpression("#{item.name}");
        xComboBox9.setItems("exemptions");
        xComboBox9.setName("entity.rpu.exemptiontype"); // NOI18N
        xComboBox9.setOpaque(false);
        xComboBox9.setStretchWidth(100);
        xFormPanel9.add(xComboBox9);
        ...
        xFormPanel1.setPadding(new java.awt.Insets(2, 5, 0, 2));

        xTextField1.setCaption("Cancel Note");
        xTextField1.setName("entity.cancelnote"); // NOI18N
        xTextField1.setStretchWidth(100);
        xFormPanel1.add(xTextField1);

        jPanel6.add(xFormPanel1, java.awt.BorderLayout.PAGE_END);
