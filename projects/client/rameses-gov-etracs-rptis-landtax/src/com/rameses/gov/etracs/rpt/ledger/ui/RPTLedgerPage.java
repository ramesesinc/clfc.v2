...
public class RPTLedgerPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xDecimalField24 = new com.rameses.rcp.control.XDecimalField();
        xDecimalField25 = new com.rameses.rcp.control.XDecimalField();
        xDecimalField26 = new com.rameses.rcp.control.XDecimalField();
        xDecimalField27 = new com.rameses.rcp.control.XDecimalField();
        xDecimalField28 = new com.rameses.rcp.control.XDecimalField();
        formPanel14 = new com.rameses.rcp.util.FormPanel();
        xDecimalField19 = new com.rameses.rcp.control.XDecimalField();
        xDecimalField20 = new com.rameses.rcp.control.XDecimalField();
        xDecimalField21 = new com.rameses.rcp.control.XDecimalField();
        xDecimalField22 = new com.rameses.rcp.control.XDecimalField();
        ...
        xDataTable5.setColumns(new com.rameses.rcp.common.Column[]{
            ...
            new com.rameses.rcp.common.Column(new Object[]{
                new Object[]{"name", "paidqtr"}
                , new Object[]{"caption", "Last Fully Paid Qtr"}
                , new Object[]{"width", 100}
                , new Object[]{"minWidth", 0}
                , new Object[]{"maxWidth", 0}
                , new Object[]{"required", false}
            ...
            new com.rameses.rcp.common.Column(new Object[]{
                ...
                , new Object[]{"caption", "Tax Difference?"}
                , new Object[]{"width", 100}
                , new Object[]{"minWidth", 0}
                , new Object[]{"maxWidth", 0}
                , new Object[]{"required", false}
            ...
            new com.rameses.rcp.common.Column(new Object[]{
                ...
                , new Object[]{"caption", "AV for Basic"}
                , new Object[]{"width", 100}
                , new Object[]{"minWidth", 0}
                , new Object[]{"maxWidth", 0}
                , new Object[]{"required", false}
        ...
        jTabbedPane2.addTab("Ledger Items", jPanel9);
        ...
        xTitledBorder1.setTitle("Payment Status");
        formPanel13.setBorder(xTitledBorder1);

        xCheckBox4.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        xCheckBox4.setMargin(new java.awt.Insets(0, 0, 0, 0));
        xCheckBox4.setName("entity.qtrlypaymentavailed"); // NOI18N
        xCheckBox4.setOpaque(false);
        xCheckBox4.setPreferredSize(new java.awt.Dimension(0, 25));
        xCheckBox4.setReadonly(true);
        xCheckBox4.setShowCaption(false);
        xCheckBox4.setText("Quarterly Payment Availed");
        formPanel13.add(xCheckBox4);

        xCheckBox5.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        xCheckBox5.setMargin(new java.awt.Insets(0, 0, 0, 0));
        xCheckBox5.setName("entity.qtrlypaymentpaidontime"); // NOI18N
        xCheckBox5.setOpaque(false);
        xCheckBox5.setPreferredSize(new java.awt.Dimension(0, 25));
        xCheckBox5.setReadonly(true);
        xCheckBox5.setShowCaption(false);
        xCheckBox5.setText("Quarterly Payment Paid On-Time");
        formPanel13.add(xCheckBox5);

        xCheckBox6.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        xCheckBox6.setMargin(new java.awt.Insets(0, 0, 0, 0));
        xCheckBox6.setName("entity.firstqtrpaidontime"); // NOI18N
        xCheckBox6.setOpaque(false);
        xCheckBox6.setPreferredSize(new java.awt.Dimension(0, 25));
        xCheckBox6.setReadonly(true);
        xCheckBox6.setShowCaption(false);
        xCheckBox6.setText("1st Qtr Paid On-Time");
        formPanel13.add(xCheckBox6);

        com.rameses.rcp.control.border.XTitledBorder xTitledBorder2 = new com.rameses.rcp.control.border.XTitledBorder();
        xTitledBorder2.setTitle("Billing Information");
        jPanel1.setBorder(xTitledBorder2);

        xDateField3.setCaption("Next Bill Date");
        ...
        formPanel15.add(xDateField3);

        xDecimalField24.setCaption("Basic");
        xDecimalField24.setCaptionWidth(100);
        xDecimalField24.setName("basic"); // NOI18N
        xDecimalField24.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField24.setReadonly(true);
        formPanel16.add(xDecimalField24);

        xDecimalField25.setCaption("Basic Discount");
        xDecimalField25.setCaptionWidth(100);
        xDecimalField25.setName("basicdisc"); // NOI18N
        xDecimalField25.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField25.setReadonly(true);
        formPanel16.add(xDecimalField25);

        xDecimalField26.setCaption("Basic Interest");
        xDecimalField26.setCaptionWidth(100);
        xDecimalField26.setName("basicint"); // NOI18N
        xDecimalField26.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField26.setReadonly(true);
        formPanel16.add(xDecimalField26);

        xDecimalField27.setCaption("Idle Land");
        xDecimalField27.setCaptionWidth(100);
        xDecimalField27.setName("basicidle"); // NOI18N
        xDecimalField27.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField27.setReadonly(true);
        formPanel16.add(xDecimalField27);

        xDecimalField28.setCaption("TOTAL BASIC");
        xDecimalField28.setCaptionWidth(100);
        xDecimalField28.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        xDecimalField28.setName("totalBasic"); // NOI18N
        xDecimalField28.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField28.setReadonly(true);
        formPanel16.add(xDecimalField28);

        xDecimalField19.setCaption("SEF");
        xDecimalField19.setCaptionWidth(100);
        xDecimalField19.setName("sef"); // NOI18N
        xDecimalField19.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField19.setReadonly(true);
        formPanel14.add(xDecimalField19);

        xDecimalField20.setCaption("SEF Discount");
        xDecimalField20.setCaptionWidth(100);
        xDecimalField20.setName("sefdisc"); // NOI18N
        xDecimalField20.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField20.setReadonly(true);
        formPanel14.add(xDecimalField20);

        xDecimalField21.setCaption("SEF Interest");
        xDecimalField21.setCaptionWidth(100);
        xDecimalField21.setName("sefint"); // NOI18N
        xDecimalField21.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField21.setReadonly(true);
        formPanel14.add(xDecimalField21);

        xDecimalField22.setCaption("TOTAL SEF");
        xDecimalField22.setCaptionWidth(100);
        xDecimalField22.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        xDecimalField22.setName("totalSef"); // NOI18N
        xDecimalField22.setPreferredSize(new java.awt.Dimension(120, 20));
        xDecimalField22.setReadonly(true);
        formPanel14.add(xDecimalField22);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    .add(formPanel15, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .add(formPanel16, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .add(jPanel1Layout.createSequentialGroup()
                ...
                .add(jPanel1Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(formPanel16, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 127, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(formPanel14, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 105, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .add(jPanel11Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(formPanel13, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 490, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel11Layout.setVerticalGroup(
            ...
            .add(jPanel11Layout.createSequentialGroup()
                ...
                .add(jPanel11Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(formPanel13, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE)
                    .add(jPanel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );

        jTabbedPane2.addTab("Billing and Other Information", jPanel11);
        ...
        xTitledBorder4.setTitle("Balance Information");
        ...
        xDecimalField14.setCaption("BASIC");
        xDecimalField14.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        xDecimalField14.setName("totalBasic"); // NOI18N
        xDecimalField14.setPreferredSize(new java.awt.Dimension(0, 20));
        xDecimalField14.setReadonly(true);
        xDecimalField14.setStretchWidth(100);
        formPanel7.add(xDecimalField14);

        xDecimalField13.setCaption("SEF");
        xDecimalField13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        xDecimalField13.setName("totalSef"); // NOI18N
        xDecimalField13.setPreferredSize(new java.awt.Dimension(0, 20));
        xDecimalField13.setReadonly(true);
        formPanel7.add(xDecimalField13);

        xDecimalField12.setCaption("Balance");
        xDecimalField12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        xTitledBorder5.setTitle("Property Information");
        formPanel10.setBorder(xTitledBorder5);
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .add(jPanel7Layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jTabbedPane2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private com.rameses.rcp.control.XDecimalField xDecimalField20;
    private com.rameses.rcp.control.XDecimalField xDecimalField21;
    private com.rameses.rcp.control.XDecimalField xDecimalField22;
    private com.rameses.rcp.control.XDecimalField xDecimalField24;
    private com.rameses.rcp.control.XDecimalField xDecimalField25;
    private com.rameses.rcp.control.XDecimalField xDecimalField26;
    private com.rameses.rcp.control.XDecimalField xDecimalField27;
    private com.rameses.rcp.control.XDecimalField xDecimalField28;
