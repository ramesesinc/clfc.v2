...
abstract class ReportController
{
    ...
    void buildReport(){
        ...
        params.LOGOBLGF = getInputStream( 'lgu-blgf.png' ) 
        params.LOGOASSESSOR = getInputStream( 'lgu-assessor.png' ) 
        params.LOGOTREASURY = getInputStream( 'lgu-treasury.png' ) 
        params.LOGOLGUURL = getURL( 'lgu-logo.png' ) 
        params.LOGOBLGFURL = getURL( 'lgu-blgf.png' ) 
        params.LOGOASSESSORURL = getURL( 'lgu-assessor.png' ) 
        params.LOGOTREASURYURL = getURL( 'lgu-treasury.png' ) 
        report.viewReport()
    }
