...
public class ApplicationInitialPageB extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xLookupField1.setExpression("#{appfranchiseno}");
        ...
        xLabel1.setExpression("#{franchise.owner.name}");
        ...
        xLabel4.setExpression("#{franchise.owner.address}");
        ...
        formPanel2.setBounds(0, 110, 490, 50);
